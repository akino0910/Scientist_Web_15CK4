					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<table class="table table-hover">
								...
								<tbody>
									...
									<tr>
										<form action="adddanhmuc.php" method="post">
											<td width="15%"><?= $row["CatID"] ?><input class="form-control" type="hidden" name="CatID" id="CatID" value="<?= $row["CatID"] ?>"></td>
											<td width="50%"><input class="form-control" name="CatName" id="CatName" value="<?= $row["CatName"] ?>"></td>
											<td class="text-right">
								...
								<div class="row">
									<div class="col-6">
										<a class="btn btn-primary" href="adddanhmuc.php" role="button"> Thêm mới</a>
									</div>
									
								</div>
								<div class="red">Lưu ý: Nếu xóa danh mục sẽ xóa tất cả các sản phẩm đang thuộc danh mục đó, vui lòng <a class="dam" href="chuyendm.php"> chuyển danh mục </a> hoặc backup lại dữ liệu trước khi xóa danh mục.</div>
							</div>
						</div>
					</div>
				</div>
