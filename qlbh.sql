...
) ENGINE = MyISAM AUTO_INCREMENT = 38 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Fixed;
...
INSERT INTO `orders` VALUES (13, '2017-12-26 13:35:41', 3, 156570000, 'Chưa giao');
...
INSERT INTO `products` VALUES (21, 'Sony Alpha a7R III', 'Bảo hành 24 tháng chính hãng', '<p>ISO 102400<br />Bộ xử l&yacute; h&igrave;nh ảnh BIONZ X &amp; LSI<br />Hệ thống lấy n&eacute;t 399 điểm<br />Chụp li&ecirc;n tục 10 khung h&igrave;nh/gi&acirc;y<br />Bộ cảm biến CMOS BSI CMOS 42MP Full-Frame Exmor R<br />Video UHD 4K30p với HLG &amp; S-Log3 Gammas<br />3,9m-Dot Tru-Finder OLED EVF<br />M&agrave;n h&igrave;nh cảm ứng LCD 3.0 \"1.44 triệu điểm ảnh<br />Chống rung 5 trục (5-Axis)<br />Pixel Shift Multi Shooting<br />T&iacute;ch hợp Wi-Fi / Bluetooth, khe SD đ&ocirc;i<br />USB 3.0 cổng loại-C &amp; thiết bị đầu cuối đồng bộ h&oacute;a PC</p>', 77990000, 3, 4, 2, 2, 10, 'Nhật Bản', '5');
...
INSERT INTO `products` VALUES (48, 'Canon EF 35mm f/1.4L II USM', 'Bảo hành 24 tháng chính hãng', '<p>- Ống k&iacute;nh ng&agrave;m EF Mount d&ograve;ng L-Series/ Full-frame Format<br />- Khẩu độ: F/1.4-F/22<br />- C&ocirc;ng nghệ sản xuất thấu k&iacute;nh Blue Spectrum Refractive<br />- Gồm 2 thấu k&iacute;nh phi cầu v&agrave; 1 thấu k&iacute;nh UD<br />- Lớp tr&aacute;ng phủ Subwavelength v&agrave; Fluorine<br />- Động cơ lấy n&eacute;t Ultrasonic Autofocus<br />- Manual Focus Override Full-Time<br />- Cấu tr&uacute;c chống chịu thời tiết<br />- 9 l&aacute; khẩu tr&ograve;n</p>', 40990000, 6, 1, 1, 4, 977, 'Nhật Bản', '1');
